...
if (strcmp(settings.referenceType,'RefSeq'))
    LocDatabases = {'data/DatabaseData/Blast_Databases/Human/NCBI_RefSeq/','data/DatabaseData/Blast_Databases/Human/NCBI_RefSeq/Human_NCBI_genomic','data/DatabaseData/Blast_Databases/Human/NCBI_RefSeq/Human_NCBI_transcript',...
        ...
        'data/DatabaseData/GTF_Databases/Rat/NCBI_RefSeq/GCF_036323735.1_GRCr8_genomic.gtf','data/DatabaseData/GFF3_Databases/Rat/NCBI_RefSeq/GCF_036323735.1_GRCr8_genomic.gff';...
        ...
        'data/DatabaseData/GTF_Databases/Fruitfly/NCBI_RefSeq/GCF_000001215.4_Release_6_plus_ISO1_MT_genomic.gtf','data/DatabaseData/GFF3_Databases/Fruitfly/NCBI_RefSeq/GCF_000001215.4_Release_6_plus_ISO1_MT_genomic.gff';...
        ...
        'data/DatabaseData/GTF_Databases/Worm/NCBI_RefSeq/GCF_000002985.6_WBcel235_genomic.gtf','data/DatabaseData/GFF3_Databases/Worm/NCBI_RefSeq/GCF_000002985.6_WBcel235_genomic.gff';...
...
elseif (strcmp(settings.referenceType,'ENSEMBL'))
    LocDatabases = {'data/DatabaseData/Blast_Databases/Human/EMBL_EBI/','data/DatabaseData/Blast_Databases/Human/EMBL_EBI/Human_ENSEMBL_genomic','data/DatabaseData/Blast_Databases/Human/EMBL_EBI/Human_ENSEMBL_transcript',...
        ...
        'data/DatabaseData/GTF_Databases/Rat/EMBL_EBI/Rattus_norvegicus.GRCr8.114.gtf','data/DatabaseData/GFF3_Databases/Rat/EMBL_EBI/Rattus_norvegicus.GRCr8.114.gff3';...
        ...
        'data/DatabaseData/GTF_Databases/Fruitfly/EMBL_EBI/Drosophila_melanogaster.BDGP6.54.114.gtf','data/DatabaseData/GFF3_Databases/Fruitfly/EMBL_EBI/Drosophila_melanogaster.BDGP6.54.114.gff3';...
        ...
        'data/DatabaseData/GTF_Databases/Worm/EMBL_EBI/Caenorhabditis_elegans.WBcel235.114.gtf','data/DatabaseData/GFF3_Databases/Worm/EMBL_EBI/Caenorhabditis_elegans.WBcel235.114.gff3';...
...
%% Gene Expression Reference Locations
cellPreset = 1;
switch cellPreset
...
elseif (strcmp(settings.referenceType,'ENSEMBL'))
    ...
    ids_gff_loc = find(strcmp(GFFobj.Feature,'region'));
    chr_list = regexp(GFFobj.Attributes(ids_gff_loc),'(?<=region:).*(?=;)','match');
    chrom_list = string(convertCharsToStrings(chr_list));

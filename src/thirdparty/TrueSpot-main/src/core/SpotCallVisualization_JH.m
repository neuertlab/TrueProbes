...
classdef SpotCallVisualization_JH
...
%imported into a callTable formatted like TrueSpot's.
    ...
    methods
        ...
        function [obj, figHandle, okay] = drawResultsBasic(obj, figHandle, thVal, z, xyView)
            ...
            viewRegion = SpotCallVisualization_JH.xyView2WorkregionStruct(xyView, obj.visCommon.idims);
            if obj.zMode == 1
                %MaxProj
                rowBool = SpotCallVisualization_JH.filterCallsToValidRange(obj.callTable, obj.workRegion, 0, 0, thVal);
                if ~isempty(xyView)
                    rowBoolV = SpotCallVisualization_JH.filterCallsToValidRange(obj.callTable, viewRegion, 0, 0, thVal);
            ...
            elseif obj.zMode == 2
                ...
                rowBool = SpotCallVisualization_JH.filterCallsToValidRange(obj.callTable,...
                    obj.workRegion, filter_z_min, filter_z_max, thVal);
                if ~isempty(xyView)
                    rowBoolV = SpotCallVisualization_JH.filterCallsToValidRange(obj.callTable, ...
        ...
        function [obj, figHandle, okay] = drawResultsTTCompare(obj, figHandle, thValA, thValB, z, xyView)
            ...
            if obj.zMode == 1
                %Draw all.
                rowBool1 = SpotCallVisualization_JH.filterCallsToValidRange(tableA, obj.workRegion, 0, 0, thValA);
                rowBool2 = SpotCallVisualization_JH.filterCallsToValidRange(tableB, obj.workRegion, 0, 0, thValB);

                if ~isempty(xyView)
                    rowBoolV = SpotCallVisualization_JH.filterCallsToValidRange(tableA, viewRegion, 0, 0, thValA);
                    rowBool1 = and(rowBool1, rowBoolV);
                    rowBoolV = SpotCallVisualization_JH.filterCallsToValidRange(tableB, viewRegion, 0, 0, thValB);
                    rowBool2 = and(rowBool2, rowBoolV);
                    clear rowBoolV
                end
            elseif obj.zMode == 2
                %Only draw for this slice.
                rowBool1 = SpotCallVisualization_JH.filterCallsToValidRange(tableA, obj.workRegion, z, z, thValA);
                rowBool2 = SpotCallVisualization_JH.filterCallsToValidRange(tableB, obj.workRegion, z, z, thValB);

                if ~isempty(xyView)
                    rowBoolV = SpotCallVisualization_JH.filterCallsToValidRange(tableA, viewRegion, z, z, thValA);
                    rowBool1 = and(rowBool1, rowBoolV);
                    rowBoolV = SpotCallVisualization_JH.filterCallsToValidRange(tableB, viewRegion, z, z, thValB);
                    rowBool2 = and(rowBool2, rowBoolV);
                    clear rowBoolV
                end
        ...
        function [obj, figHandle, okay] = drawResultsTRCompare(obj, figHandle, thVal, z, xyView)
            ...
            if obj.zMode == 1
                rowBoolCall = SpotCallVisualization_JH.filterCallsToValidRange(tableC, obj.workRegion, 0, 0, thVal);
                rowBoolV = SpotCallVisualization_JH.filterCallsToValidRange(tableC, viewRegion, 0, 0, thVal);
                rowBoolCall = and(rowBoolCall, rowBoolV);

                rowBoolRef = SpotCallVisualization_JH.filterCallsToValidRangeMtx(tableR, obj.workRegion, 0, 0);
                rowBoolV = SpotCallVisualization_JH.filterCallsToValidRangeMtx(tableR, viewRegion, 0, 0);
                rowBoolRef = and(rowBoolRef, rowBoolV);
            elseif obj.zMode == 2
                rowBoolCall = SpotCallVisualization_JH.filterCallsToValidRange(tableC, obj.workRegion, z, z, thVal);
                rowBoolV = SpotCallVisualization_JH.filterCallsToValidRange(tableC, viewRegion, z, z, thVal);
                rowBoolCall = and(rowBoolCall, rowBoolV);

                rowBoolRef = SpotCallVisualization_JH.filterCallsToValidRangeMtx(tableR, obj.workRegion, z, z);
                rowBoolV = SpotCallVisualization_JH.filterCallsToValidRangeMtx(tableR, viewRegion, z, z);
                rowBoolRef = and(rowBoolRef, rowBoolV);
            else
                return;
            end
        ...
        function [obj, figHandle, okay] = drawReferenceSet(obj, figHandle, z, xyView)
            ...
            elseif obj.zMode == 2
                ...
                rowBoolRef = SpotCallVisualization_JH.filterCallsToValidRangeMtx(tableR,...
                    obj.workRegion, filtz_min, filtz_max);
                if ~isempty(xyView)
                    rowBoolV = SpotCallVisualization_JH.filterCallsToValidRangeMtx(tableR,...
        ...
        function [obj, figHandle] = onRefModeClick(obj, figHandle, x, y, z, allowAdd, allowRemove)
            ...
            cRad = SpotCallVisualization_JH.calculateClickRadius(figHandle, X, Y);
            x = x + obj.xOffset;
            y = y + obj.yOffset;
            ...
            if ~isempty(obj.referenceTable.data)
                ...
                rowBool = SpotCallVisualization_JH.filterCallsToValidRangeMtx(...
        ...
        function spotCount = getSpotCountMainCallset(obj, xyView, z, thVal)
            ...
            if (obj.zMode == 1) | (z < 1)
                ...
                rowBool = SpotCallVisualization_JH.filterCallsToValidRange(obj.callTable, obj.workRegion, z, z, thVal);
                if ~isempty(xyView)
                    rowBoolV = SpotCallVisualization_JH.filterCallsToValidRange(obj.callTable, viewRegion, z, z, thVal);
                    rowBool = and(rowBool, rowBoolV);
                end
                spotCount = nnz(rowBool);
            end

...
if (calcSiteMap > 0)
    ...
    DoesProbeBindSite = ndSparse.build([size(probes,1),length(Names),size(probes,1)-Lpmin+1],0);
    Kb_mod = ndSparse.build([size(probes,1),length(Names),size(probes,1)-Lpmin+1,N_methods],0);
    dHeq_mod = ndSparse.build([size(probes,1),length(Names),size(probes,1)-Lpmin+1,N_methods],0);
    dSeq_mod = ndSparse.build([size(probes,1),length(Names),size(probes,1)-Lpmin+1,N_methods],0);
    dCp_mod = ndSparse.build([size(probes,1),length(Names),size(probes,1)-Lpmin+1,N_methods],0);
    dHf_mod = ndSparse.build([size(probes,1),length(Names),size(probes,1)-Lpmin+1,N_methods2],0);
    dHr_mod = ndSparse.build([size(probes,1),length(Names),size(probes,1)-Lpmin+1,N_methods2],0);
    dSf_mod = ndSparse.build([size(probes,1),length(Names),size(probes,1)-Lpmin+1,N_methods2],0);
    dSr_mod = ndSparse.build([size(probes,1),length(Names),size(probes,1)-Lpmin+1,N_methods2],0);
    Tm_mod = ndSparse.build([size(probes,1),length(Names),size(probes,1)-Lpmin+1,N_methods+1],0);

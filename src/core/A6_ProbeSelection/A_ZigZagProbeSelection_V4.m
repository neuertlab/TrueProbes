function chosenProbes = A_ZigZagProbeSelection_V4(AllowableProbes,AllowMatrix,ProbesWithRibosomalHits,OFF_RNAIDs,probes,settings,addSelfProb,packOptimal,Kon,Nvec_RNAmulti,Off_Score,Specificity_Score,Tvec_RNA,Svec_RNA,TPvec_RNA,TSvec_RNA,TPvec_logKOFF_RNA,TPvec_logKOFFdivON_RNA,TPvec_logKONdivOFF_RNA,ExpressionMatrix,DoesProbeBindSite,Kb)
